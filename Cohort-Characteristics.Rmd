...
listVars <- c("age", "sex", "QFT", "SchistosomaIntensity")

#Define categorical variables
catVars <- c("TB","SM")

mediqr<- c("age", "QFT", "SchistosomaIntensity")

#Total Population
table1 <- CreateTableOne(vars = listVars, data = DonorInfo, factorVars = catVars,
                         strata = c("TB", "SM"))
test<- print(table1, showAllLevels = TRUE, nonnormal = mediqr, quote = FALSE, noSpaces = TRUE,
             printToggle = FALSE)
...
res.total<-descrTable(~ age + sex + QFT + SchistosomaIntensity, data = DonorInfo)
