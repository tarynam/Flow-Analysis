...
baseplot(melt, "SM", "value", healthy.cols)+
    ...
    labs(y="Frequency of Cytokine+ CD4+ T cells (%)")+coord_cartesian(ylim=c(0,40))
```
...
a<-baseplot(melt[melt$variable=="T-bet",], "SM", "value", ltbi.cols)+    
    facet_wrap(~variable)+
    labs(y="(%) Total CD4+ T cells")

b<-baseplot(melt[melt$variable=="GATA3",], "SM", "value", ltbi.cols)+    
    facet_wrap(~variable)
c<-baseplot(melt[melt$variable=="CXCR3",], "SM", "value", ltbi.cols)+    
    facet_wrap(~variable)

d<-baseplot(melt[melt$variable=="CCR4",], "SM", "value", ltbi.cols)+    
    facet_wrap(~variable)
...
a<-baseplot(melt[melt$variable=="T-bet",], "disease", "value", ltbi.cols)+    
    facet_wrap(~variable)+
    labs(y="(%) Total CD4+ T cells")+coord_cartesian(ylim=c(0,100))

b<-baseplot(melt[melt$variable=="GATA3",], "disease", "value", ltbi.cols)+    
    facet_wrap(~variable)+coord_cartesian(ylim=c(0,100))
...
```{r tb cytokine ics, fig.width=16, fig.height=8}
...
a<-baseplot(melt[melt$variable=="T-bet",], "SM", "value", tb.cols)+    
    facet_wrap(~variable)+
    labs(y="(%) Total CD4+ T cells")

b<-baseplot(melt[melt$variable=="GATA3",], "SM", "value", tb.cols)+    
    facet_wrap(~variable)

c<-baseplot(melt[melt$variable=="CXCR3",], "SM", "value", tb.cols)+    
    facet_wrap(~variable)

d<-baseplot(melt[melt$variable=="CCR4",], "SM", "value", tb.cols)+    
    facet_wrap(~variable)
