...
first_row = cowplot::plot_grid(NULL, NULL, labels = c('A', 'B'), nrow=1, label_size = 20, rel_widths = c(3,1))
second_row = cowplot::plot_grid(og, one, two, nrow=1, rel_widths = c(1,2,1), labels=c("C","D","E"), label_size = 20)
third_row= cowplot::plot_grid(tf, sm, labels=c('F', 'G'), nrow=1, label_size = 20)

figure6<-cowplot::plot_grid(first_row, second_row, third_row, nrow=3, rel_heights = c(1.5,2,2))
```
...
cowplot::save_plot("figure4.png", figure4, base_height=14, base_width=12)
